    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-start">
          <div className="max-w-2xl">
            ...
            <ScrollReveal>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-6">
                <div className="flex items-start gap-2 bg-brand-50/70 dark:bg-brand-900/20 rounded-xl px-3.5 py-2.5 border border-brand-200/50 dark:border-brand-800/30 min-w-0">
                  <div className="w-6 h-6 bg-brand-600 rounded-full flex items-center justify-center shrink-0 mt-0.5">
                    <CalendarCheck className="w-3.5 h-3.5 text-white" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-xs sm:text-sm font-bold text-navy-800 dark:text-white tracking-tight whitespace-nowrap overflow-hidden text-ellipsis">
                      Sunday, 23 August 2026 <span className="text-brand-600 dark:text-brand-400 mx-0.5">•</span> 9:00 AM to 4:00 PM
                    </p>
                ...
                <div className="flex items-start gap-2 bg-accent-50/70 dark:bg-accent-900/20 rounded-xl px-3.5 py-2.5 border border-accent-200/50 dark:border-accent-800/30">
                  ...
                  <div>
                    <p className="text-xs sm:text-sm font-bold text-navy-800 dark:text-white">Baba Gambhirnath Auditorium</p>
                ...
                <div className="flex items-start gap-2 bg-emerald-50/70 dark:bg-emerald-900/20 rounded-xl px-3.5 py-2.5 border border-emerald-200/50 dark:border-emerald-800/30">
                  ...
                  <div>
                    <p className="text-xs sm:text-sm font-bold text-navy-800 dark:text-white">Farmers to Leaders</p>
          ...
          <div className="flex justify-center items-start relative pt-4 md:pt-4 w-full">
            <ScrollReveal className="w-full max-w-sm">
              <div className="relative w-full overflow-hidden">
                ...
                <div className="relative rounded-3xl overflow-hidden bg-gradient-to-b from-navy-900 via-navy-800 to-navy-900 shadow-2xl border border-white/15 p-5 sm:p-6">
                  <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-brand-500 via-accent-500 to-brand-500" />
                  
                  {/* Header Info */}
                  <div className="text-center mb-5">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white p-2 border border-brand-200 shadow-xl mb-3">
                    ...
                    <p className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-brand-400 mb-0.5">1st Poultry Conclave</p>
                    <h3 className="text-2xl font-black text-white tracking-tight leading-tight">Gorakhpur 2026</h3>
                    <p className="text-brand-200 text-xs font-medium mt-0.5">Innovate • Collaborate • Grow</p>
                    
                    {/* Event Meta Badges */}
                    <div className="mt-4 space-y-2">
                      <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md rounded-xl p-2.5 border border-white/10 text-left">
                        ...
                        <div className="min-w-0">
                          <p className="text-xs font-bold text-white leading-tight">Sunday, 23 August 2026</p>
                          <p className="text-[11px] text-brand-300 font-medium mt-0.5 flex items-center gap-1">
                            <Clock className="w-3 h-3 text-brand-400 inline shrink-0" /> 9:00 AM to 4:00 PM
                          </p>
                        </div>
                      </div>

                      <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md rounded-xl p-2.5 border border-white/10 text-left">
                        <div className="p-2 rounded-lg bg-accent-500/10 border border-accent-500/20 shrink-0">
                          <MapPin className="w-4 h-4 text-accent-400" />
                        </div>
                        <div className="min-w-0">
                          <p className="text-xs font-bold text-white leading-tight">Baba Gambhirnath Auditorium</p>
                          <p className="text-[11px] text-slate-300 font-normal mt-0.5">Taramandal, Gorakhpur</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={t.title} className="flex items-center gap-3 bg-white/5 hover:bg-white/10 rounded-xl px-3 py-2 transition-all border border-white/5">
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-2.5">
                    <Link
                      href="/register"
                      className="group relative overflow-hidden flex items-center justify-center gap-1.5 bg-gradient-to-r from-brand-500 to-accent-600 hover:from-brand-600 hover:to-accent-700 text-white text-xs font-bold px-3 py-2.5 rounded-xl shadow-lg transition-all text-center"
                    >
                      <CalendarCheck className="w-3.5 h-3.5 shrink-0" /> Register
                    </Link>
                    <a
                      href="tel:+919336212329"
                      className="flex items-center justify-center gap-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold px-3 py-2.5 rounded-xl transition-all border border-white/10 text-center"
                    >
