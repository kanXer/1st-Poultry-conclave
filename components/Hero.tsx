...
import { CalendarCheck, MapPin, ShieldCheck, Sunrise, ChevronRight, Phone, MessageSquare, Users, TrendingUp, Microscope, Leaf, Egg, Building2 } from "lucide-react"
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className="mt-4 space-y-2">
                      <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-1.5 border border-white/10">
                        ...
                        <span className="text-xs font-semibold text-white whitespace-nowrap">Sunday, 23 August 2026 • 9:00 AM to 4:00 PM</span>
                      </div>
                      <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-1.5 border border-white/10">
